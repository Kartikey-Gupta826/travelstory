const ADD_STORY_IMG = "/assets/images/add-story.svg";
const NO_SEARCH_DATA_IMG = "/assets/images/no-search-data.svg";
const NO_FILTER_DATA_IMG = "/assets/images/no-filter-data.svg";
